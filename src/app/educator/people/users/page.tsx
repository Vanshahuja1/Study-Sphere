                            ...
                            <div className="shadow-2xl fixed right-0 top-0 bg-white w-2/5 z-100 rounded-s-2xl h-screen overflow-x-auto">
                                ...
                                <div className="flex flex-col my-3 gap-4 px-5 py-3">
                                    <div className="bg-gray-50 p-3 rounded-xl">
                                        ...
                                        <h3 className='text-gray-800 font-semibold my-2 border-t pt-2'>User Status</h3>
                                        <div className="flex gap-2 text-gray-600 my-1 ">
                                            <input type="checkbox" name="radio" id='me' />
                                            <label htmlFor="radio">Active</label>
                                        </div>
                                        <div className="flex gap-2 text-gray-600 my-1">
                                            <input type="checkbox" name="radio" id='institute' />
                                            <label htmlFor="radio">Pending Installment</label>
                                        </div>
                                        <div className="flex gap-2 text-gray-600 my-1 ">
                                            <input type="checkbox" name="radio" id='imported' />
                                            <label htmlFor="radio">Inactive</label>
                                        </div>
                                        <div className="flex gap-2 text-gray-600 my-1 ">
                                            <input type="checkbox" name="radio" id='imported' />
                                            <label htmlFor="radio">Expired</label>
                                        </div>
                                    </div>
                                    <div className="bg-gray-50 p-3 rounded-xl">
                                        <h3 className='text-gray-800 font-semibold my-2'>User Type</h3>
                                    ...
                                    <div className="bg-gray-50 p-3 rounded-xl">
                                        <h3 className='text-gray-800 font-semibold my-2'>App Downloads</h3>
                                        <div className="flex gap-2 my-1">
                                            <input type="checkbox" name="public" id="" />
                                            <label htmlFor="public">App Downloaded</label>
                                        </div>
                                        <div className="flex gap-2 my-1">
                                            <input type="checkbox" name="public" id="" />
                                            <label htmlFor="public">App Not Downloaded</label>
                                        </div>
                                    </div>
                                    <div className="bg-gray-50 p-3 rounded-xl">
                                        <h3 className='text-gray-800 font-semibold my-2'>Block Status</h3>
                                        <div className="flex gap-2 text-gray-700 my-1 ">
                                            <input type="checkbox" name="radio" id='me' />
                                            <label htmlFor="radio">Blocked Students</label>
                                        </div>
                                        <div className="flex gap-2 text-gray-700 my-1">
                                            <input type="checkbox" name="radio" id='institute' />
                                            <label htmlFor="radio">Unblocked Students</label>
                                        </div>
                                    </div>
                                    <div className="bg-gray-50 p-3 rounded-2xl">
                                        <h3 className='text-gray-800 font-semibold my-2'>Date of joining</h3>
                                        <select name="" id="" className="bg-white w-full p-3 rounded-2xl
                                        border">

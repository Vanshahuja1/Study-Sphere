    ...
    return <main className=" w-full">
        ...
        <motion.section variants={itemVariants} initial="hidden" animate="visible" className="py-5 bg-white">
            <div className="container max-w-5xl mx-auto">
                <div className="flex gap-2  shadow-lg my-2 relative bg-linear-to-r from-indigo-50 rounded-2xl py-7 px-6 to-purple-50">
                    <div className="w-3/4">
                        <h2 className="text-3xl font-bold my-1"><span className="bg-linear-to-r from-indigo-500 to bg-purple-500 text-transparent bg-clip-text">Connect 1-on-1</span> with your audiences to offer personalized consultations</h2>
                        ...
                        {offerings.map((card, i) => {
                            return <div key={i} className="border shadow-sm hover:shadow-md transition-shadow border-gray-200 rounded-2xl px-3 py-4">
                                <div className="flex gap-3 my-1 items-center">
                                    <div className="bg-purple-200 p-2 text-slate-700 rounded-3xl">{card.icon}</div>

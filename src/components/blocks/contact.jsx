...
export default function Contact({phone,email,address ,textColor,bgColor,font}) {
    ...
    return (
        <section className={`w-full py-15 bg-white ${font}`}>
            <div className="container  mx-auto max-w-5xl px-5 justify-center items-center flex flex-col gap-4">
                <h1 className={`text-4xl ${textColor} text-blue-500 flex items-center gap-4`}> {email} <LucideUsers className="w-8 h-8"></LucideUsers></h1>

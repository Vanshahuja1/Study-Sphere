        ...
        <motion.section variants={itemVariants} animate="visible" initial='hidden'  className="py-5 bg-indigo-50">
            <div className="container max-w-5xl mx-auto">
                <div className="grid grid-cols-3 grid-rows-2 py-5 gap-4 ">
                    ...
                    <div className="relative h-50 shadow-2xl bg-white p-6 rounded-2xl border-gray-200 border w-full ">
                        <div className="flex items-center gap-7">
                            <div className="">
                                <Image src={GoogleAna} alt="image" height={40} width={40} ></Image>
                            </div>
                            <div className="">
                                <h3 className="font-bold text-xl text-gray-900">Google Analytics</h3>
                        ...
                        <p className="text-primary absolute bottom-3 my-2 px-3 font-bold flex items-end gap-1 cursor-pointer">Connect <ArrowRight className="h-5" /></p>
                    </div>

                     <div className="relative  shadow-2xl  bg-white p-6 rounded-2xl border-gray-200 border w-full ">
                        <div className="flex items-center gap-7">
                            <div className="">
                                <Image src={facepixel} alt="image" height={40} width={40} ></Image>
                            </div>
                            <div className="">
                                <h3 className="font-bold text-xl text-gray-900">Facebook Pixels</h3>
                                <div className="flex gap-3 mt-1">
                                    <span className="flex items-center gap-1 text-sm text-gray-900">Not Connected</span>
                                </div>
                            </div>
                     ...
                     <div className="relative  shadow-2xl h-50 bg-white p-6 rounded-2xl border-gray-200 border w-full ">
                        <div className="flex items-center gap-7">
                            <div className="">
                                <Image src={googleAds} alt="image" height={40} width={40} ></Image>
                            </div>
                            <div className="">
                                <h3 className="font-bold text-xl text-gray-900">Google Ads</h3>
                        ...
                        <p className="text-primary absolute bottom-3 px-3 font-bold flex items-end gap-1 cursor-pointer">Connect <ArrowRight className="h-5" /></p>
                    </div>
                    ...
                    <div className="relative shadow-2xl  h-50 bg-white p-6 rounded-2xl border-gray-200 border w-full ">
                        <div className="flex items-center gap-7">
                            ...
                            <div className="">
                                <h3 className="font-bold text-xl text-gray-900">Webhooks</h3>
                                <div className="flex gap-3">
                                    <span className="flex items-center gap-1 text-sm text-gray-900">Not Connected</span>
                                </div>
                            </div>
                    ...
                    <div className="relative shadow-2xl  h-50 bg-white p-6 rounded-2xl border-gray-200 border w-full ">
                        <div className="flex items-center gap-7">
                            ...
                            <div className="">
                                <h3 className="font-bold text-xl text-gray-900">Zoom</h3>
                                <div className="flex gap-3">
                                    <span className="flex items-center gap-1 text-sm text-gray-900">Not Connected</span>
                                </div>
                            </div>
